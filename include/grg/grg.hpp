...
class SolverGRG : public crocoddyl::SolverAbstract {
 public:
  ...
  virtual void computeDirection(const bool recalcDiff, std::size_t iter_);
  ...
  void set_use_line_search(bool use_line_search) { ust_line_search_ = use_line_search; };
 ...
 protected:
  ...
  bool ust_line_search_ = false;
  bool const_step_length_ = 1.0;
