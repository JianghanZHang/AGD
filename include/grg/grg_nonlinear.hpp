#ifndef MIM_SOLVERS_GRG_nonliear_HPP_
#define MIM_SOLVERS_GRG_nonliear_HPP_
...
class SolverGRG_nonlinear : public crocoddyl::SolverAbstract {
 public:
  EIGEN_MAKE_ALIGNED_OPERATOR_NEW

  explicit SolverGRG_nonlinear(boost::shared_ptr<crocoddyl::ShootingProblem> problem);
  virtual ~SolverGRG_nonlinear();
